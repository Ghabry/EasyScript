...
class ChangeGold : public CommandBase<ChangeGold> {
public:
	ChangeGold(State& state) : CommandBase<ChangeGold>(state) {}

	ChangeGold Add(VariableArg value);
	ChangeGold Sub(VariableArg value);

	static constexpr std::array name = { "ChangeGold", "party", "gold" };
	static constexpr Code code = Code::ChangeGold;
